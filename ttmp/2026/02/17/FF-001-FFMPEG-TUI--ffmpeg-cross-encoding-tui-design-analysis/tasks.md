...
- [ ] Get user feedback on mockups and open questions
...
- [ ] Phase 7: Async ffmpeg encoder worker with -progress pipe parsing
- [ ] Phase 8: Encode screen — progress bar, stats, ffmpeg log
- [ ] Phase 9: Done screen — results summary table with size savings
